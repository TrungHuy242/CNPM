    ...
    return (
        <section className='search d-flex align-items-center'>
            <div className='search-wrapper w-100 my-3'>
                ...
                <h1 className='sunset-hotel-title'>Sunset Hotel</h1>
                    <DatePicker
                    ...
                    <button className='btn btn-primary' onClick={() => dispatch({
                        ...
                        payload: {
                            ...
                            adults: newData.adults || data.adults, // Thêm số người lớn
                            children: newData.children || data.children, // Thêm số trẻ em
                            ...newData,
                        }
                    })}><span>Kiểm tra phòng </span> </button>
                </div>
            </div>
        </section>
    )
